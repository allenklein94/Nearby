...
-- This file is a snapshot for disaster-recovery / staging-standup purposes, not
-- meant to be hand-edited — future schema changes should still go through a real
-- migration file in supabase/migrations/, per this repo's standing convention.
