...
const VALID_OCCASIONS = [
  ...
  'engagement', 'housewarming', 'promotion', 'farewell', 'milestone', 'bachelor_bachelorette', 'fundraiser', 'first_date', 'other',
];
