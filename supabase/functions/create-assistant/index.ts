...
- partyType: one of ${JSON.stringify(VALID_PARTY_TYPES)} if the text implies who this is for (e.g. "just me"/"solo" is "solo", "me and my friends" is "friends", "a big group" is "groups", "a date"/"with my partner"/"with my girlfriend"/"with my boyfriend" is "date"), or null if no such signal was mentioned at all. Never guess.
