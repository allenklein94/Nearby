-- Item 83 (owner, 2026-09-26): VIBE is a named view over the ONE shared attribute vocabulary (src/constants/vibe.js), declared
-- by the business owner, never inferred. Casual, upscale, romantic, quiet and kid_friendly (family-friendly) already exist;
-- six keys join the vocabulary (34 -> 40): lively (also what "energetic" asks for), trendy, relaxed, social, cozy, professional.
-- Same recipe as 20270216: the six CHECKs and the six validating functions are widened in place from their live bodies,
-- guarded to fail loudly. No new column, table or function; ranking stays client-side and ranking-only.

do $mig$
declare
  new_list text := $q$'outdoor_seating', 'date_friendly', 'group_friendly', 'live_music', 'kid_friendly', 'quiet', 'casual', 'upscale', 'specialty_coffee', 'laptop_friendly', 'dog_friendly', 'waterfront', 'late_night', 'board_game_friendly', 'photography_friendly', 'book_lovers', 'craft_friendly', 'fitness_focused', 'private_dining', 'corporate_events', 'wifi', 'food_available', 'beginner_friendly', 'reservation_required', 'wheelchair_accessible', 'accessible_parking', 'accessible_restroom', 'service_animal_friendly', 'stroller_friendly', 'family_seating', 'kid_menu', 'pet_friendly', 'romantic', 'catering', 'lively', 'trendy', 'relaxed', 'social', 'cozy', 'professional'$q$;
begin
...
begin
  ...
  loop
    ...
    v_new := replace(v_def, $q$'romantic', 'catering'$q$, $q$'romantic', 'catering', 'lively', 'trendy', 'relaxed', 'social', 'cozy', 'professional'$q$);
