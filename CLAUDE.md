...
long-lived containers; group_occasion already follows its group plan). Still open (no ask yet): no cancellation-reason analytics. Not exercised on real data (prod has no reservations).
