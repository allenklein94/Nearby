...
describe('host-declared practical facts (item 39)', () => {
  ...
  it('every chip fits the database range and the wiring exists end to end', () => {
    ...
    expect(r('src/services/gatherings.js')).toMatch(/equipment_provided, duration_minutes, genre, format, skill_level, effort_level, features, suited_age_min, suited_age_max'/);
