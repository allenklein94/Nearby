...
describe('organic code never touches the sponsored system', () => {
  const allowed = [
    ...
    'src/constants/sponsored.js', 'src/screens/DiscoverHubScreen.js', 'src/screens/SettingsScreen.js',
  ...
  it('no other migration references the sponsored tables (organic SQL never reads them)', () => {
    ...
    const offenders = fs.readdirSync(dir)
      .filter((f) => !['20270154_sponsored_placements.sql', '20270155_sponsored_purchase_and_payments.sql'].includes(f))
